...
<body>
  ...
  <div class="form-group">
    <label for="tda">Date(YYYY-MM-DD)</label>
  ...
  <div class="form-group">
    <label for="tdae">Due date(YYYY-MM-DD)</label>
    <input type="text" class="form-control" id="tdae" name="duedate" >
  </div>
  <div class="form-group">
